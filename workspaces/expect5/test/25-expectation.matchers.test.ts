...
describe('Expectations Matcher', () => {
  it('should expect with matchers', () => {
    ...
    expectPass(() => expect.toBeNullable().expect(null))
    expectPass(() => expect.toBeNullable().expect(undefined))
  ...
  it('should expect negatively with matchers', () => {
    ...
    expectPass(() => expect.not.toBeNullable().expect(0))
  ...
  it('should expect failures with matchers', () => {
    ...
    expectFail(() => expect.toBeNullable().expect(false), 'Expected false to be <null> or <undefined>')
  ...
  it('should expect failures negatively with matchers', () => {
    ...
    expectFail(() => expect.not.toBeNullable().expect(null), 'Expected <null> not to be <null> or <undefined>')
    expectFail(() => expect.not.toBeNullable().expect(undefined), 'Expected <undefined> not to be <null> or <undefined>')
