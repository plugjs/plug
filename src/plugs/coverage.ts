...
import { Plug, Result, RunContext, Runnable } from '../types'
...
declare module '../pipe' {
  export interface Pipe {
     ...
     */
    coverage(coverageDir: string): Runnable<undefined>
    /**
     * Analyse coverage using files generated by V8/NodeJS.
     *
     * @param coverageDir The directory where the `coverage-XXX.json` files
     ...
     */
    coverage(coverageDir: string, options: CoverageOptions): Runnable<undefined>
    /**
